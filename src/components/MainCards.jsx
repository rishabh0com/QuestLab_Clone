...
const MainCards = () => {
  return (
    <div
      class="py-10 md:py-20 px-4 md:px-20"
      style={{
      ...
      <div class=" w-full max-w-[1200px] m-auto ">
        <div
          ...
          <div class="p-6 border border-home-4 rounded-3xl relative overflow-hidden text-center bg-[#151515]">
            <img class="w-12 relative z-10 m-auto" src={img1} alt="" />
            <p class="text-white text-2xl mt-6 relative z-10">
              AI Personalization
            </p>
            <p class=" text-[#939393] text-sm lg:text-[16px] mt-3 relative z-10">
              AI-driven personalization enhances user engagement with unique
              experiences.
            </p>
            <div
              class="w-[200%] h-80 bg-[#a1aee505] -rotate-[60deg] rounded-lg absolute top-1/2 -right-2/3 z-0"
              style={{
                opacity: "1",
          ...
          <div class="p-6 border border-home-4 rounded-3xl relative overflow-hidden text-center bg-[#151515]">
            <img class="w-12 relative z-10 m-auto" src={img2} alt="" />
            <p class="text-white text-2xl mt-6 relative z-10">
              Real-Time Insights
            </p>
            <p class=" text-[#939393] text-sm lg:text-[16px] mt-3 relative z-10">
          ...
          <div class="p-6 border border-home-4 rounded-3xl relative overflow-hidden text-center bg-[#151515]">
            <img class="w-12 relative z-10 m-auto" src={img3} alt="" />
            <p class="text-white text-2xl mt-6 relative z-10">
          ...
          <div class="p-6 border border-home-4 rounded-3xl relative overflow-hidden text-center bg-[#151515]">
            <img class="w-12 relative z-10 m-auto" src={img4} alt="" />
            <p class="text-white text-2xl mt-6 relative z-10">
              Dynamic Content
            </p>
            <p class=" text-[#939393] text-sm lg:text-[16px] mt-3 relative z-10">
          ...
          <div class="p-6 border border-home-4 rounded-3xl relative overflow-hidden text-center bg-[#151515]">
            <img class="w-12 relative z-10 m-auto" src={img5} alt="" />
            <p class="text-white text-2xl mt-6 relative z-10">
              Highly Scalable
            </p>
            <p class=" text-[#939393] text-sm lg:text-[16px] mt-3 relative z-10">
          ...
          <div class="p-6 border border-home-4 rounded-3xl relative overflow-hidden text-center bg-[#151515]">
            <img class="w-12 relative z-10 m-auto" src={img6} alt="" />
            <p class="text-white text-2xl mt-6 relative z-10">
              Robust Security
            </p>
            <p class=" text-[#939393] text-sm lg:text-[16px] mt-3 relative z-10">
